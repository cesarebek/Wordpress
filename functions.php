...
if ( ! function_exists( 'awesome_theme_setup' ) ) :
	...
	function awesome_theme_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'awesome_theme_custom_background_args',
				array(
...
function awesome_theme_scripts() {
	wp_enqueue_style( 'awesome-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'awesome-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'awesome-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
